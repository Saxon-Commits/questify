      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <FeatureCard
            icon="🏰"
            title="Social Guilds"
            description="Join or create guilds with friends. Share bounties, compete on leaderboards, and tackle group challenges together."
          ...
          <FeatureCard
            icon="📜"
            title="The Journal"
            description="Document your journey with daily entries. Track your wins, reflect on setbacks, and watch your story unfold over time."
            borderClass="hover:border-rose-500"
            colorClass="group-hover:bg-rose-500/20"
          ...
          <FeatureCard
            ...
            description="Your character evolves with you. Unlock new gear, cosmetics, and visual upgrades as you level up your real-life skills."
          ...
          <FeatureCard
            icon="🐾"
            title="Companions"
            description="Recruit loyal companions to aid your journey. Each brings unique bonuses and grows stronger as you complete bounties together."
